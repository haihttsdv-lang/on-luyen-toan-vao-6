...
- Đã xây đủ 4 trụ cột: **Lý thuyết** (danh sách theo nhóm, trang bài học, kiểm tra nhanh, trạng thái Chưa học/Đang học/Đã nắm), **Luyện tập** (chọn chuyên đề, lời giải từng bước, sổ lỗi), **Thi thử** (SPRINT/STANDARD/MIXED có sẵn, **+ tạo đề tùy chỉnh** tự chọn chuyên đề/số câu/thời gian rồi sinh ngẫu nhiên từ ngân hàng bài luyện tập, đồng hồ đếm ngược, chấm tự động, lịch sử + biểu đồ xu hướng), **Hồ sơ & Lộ trình** (bản đồ năng lực theo mức thành thạo, gợi ý tối đa 3 việc nên làm kèm lý do, kiểm tra đầu vào, trang tổng quan phụ huynh).
