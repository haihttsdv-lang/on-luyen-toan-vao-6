...
## Trạng thái hiện tại (GĐ0–GĐ2)

- Đã xây: `core/answer-checker` (chấm đáp số, phủ FR-M05→M14), `core/error-log`, `data-access` (Dexie), 3 chuyên đề mẫu (DH-01, PS-01, HH-02) với 20 bài tập, module Luyện tập đầy đủ (chọn chuyên đề, làm bài, lời giải từng bước, sổ lỗi).
- Chưa xây (các lượt sau): module Lý thuyết (GĐ3), Thi thử (GĐ4), Hồ sơ & Lộ trình (GĐ5), mở rộng nội dung đủ 57 chuyên đề (GĐ6), rà soát nội dung 3 lớp (GĐ7).
