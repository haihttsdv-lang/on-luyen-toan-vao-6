...
- Lõi thuật toán (`core/`): `answer-checker` (chấm đáp số, FR-M05→M14), `error-log`, `error-analysis` (thống kê lỗi theo chuyên đề/loại lỗi, FR-P08), `topic-progress`, `test-generator` (sinh đề theo tỷ trọng), `mastery-engine` (tính mức thành thạo có trọng số + gợi ý lộ trình), `schedule` (sinh lịch học thích ứng), `rewards` (xu, chuỗi ngày, huy hiệu) — toàn bộ là hàm thuần, không I/O, có unit test riêng.
