...
- Nội dung: đủ **67/67 chuyên đề** theo URD v2.0 (6 nhóm SH/PS/DH/HH/DL/TD, bao gồm cả 10 chuyên đề mới SH-11/12, PS-11, DH-15/16/17, HH-12, DL-07/08, TD-07) với lý thuyết + ví dụ + kiểm tra nhanh, và **535 bài tập** (466 điền đáp số, 60 trắc nghiệm, 9 tự luận). 14 chuyên đề trọng điểm có 12 bài/chuyên đề; 53 chuyên đề còn lại (43 chuyên đề cũ + 10 chuyên đề mới) hiện có 6–8 bài/chuyên đề — vẫn thấp hơn mục tiêu 12–15 bài/chuyên đề của URD, cần bổ sung thêm ở các lượt sau.
...
- Kiểm chứng nội dung (Mục 18 URD v2.0): đã qua **lớp 1** (kiểm tra cấu trúc tự động) và **lớp 2** (giải lại độc lập bằng agent con tách biệt, đối chiếu tự động — 535/535 bài khớp, 0 điểm lệch đáp số). Chi tiết: [`docs/content-review-log.md`](./docs/content-review-log.md).
...
Thang 4 mức độ M1–M4 (hiện vẫn dùng `basic`/`advanced` — kể cả 10 chuyên đề mới vừa thêm), Gamification (xu/huy hiệu/âm thanh), Đồng bộ đa thiết bị qua Firebase, UI/UX Mục 11 còn lại (thanh tab đáy di động, phím tắt, đọc đề bằng giọng nói, bản in phụ huynh, layout 2 cột cho bài có hình/bảng), gợi ý sau khi làm sai (hint) và trang phân tích lỗi theo loại lỗi, mở rộng bài tập lên mục tiêu đầy đủ 12–15 bài/chuyên đề. Stack công nghệ **giữ nguyên** React 18 + CSS thuần + Dexie/IndexedDB (không nâng cấp Tailwind v4/React 19/localStorage như URD v2.0 "chốt" — quyết định có chủ đích, xem ADR).
